...
extern "C" void MYCDECL CUSTOM_FREE(void *ptr) { xxfree(ptr); }
...
extern "C" int CUSTOM_POSIX_MEMALIGN(void **memptr, size_t alignment,
                                     size_t size)
#if !defined(__FreeBSD__) && !defined(__SVR4)
    throw()
#endif
...
extern "C" void MYCDECL CUSTOM_CFREE(void *ptr) { xxfree(ptr); }
...
extern "C" char *MYCDECL CUSTOM_GETCWD(char *buf, size_t size) {
  static getcwdFunction *real_getcwd = reinterpret_cast<getcwdFunction *>(
...
// fgetc, _fgetchar, fgets, fprintf, fputc, _fputchar, fputs, fread, fscanf,
// fseek, fsetpos _fullpath, fwrite, getc, getchar, _getcwd, _getdcwd, gets,
// _getw, _popen, printf, putc putchar, _putenv, puts, _putw, scanf, _searchenv,
// setvbuf, _strdup, system, _tempnam, ungetc, vfprintf, vprintf
