 ...
 * @note   Copyright (C) 2010 by Emery Berger, University of Massachusetts
 * Amherst.
 */
...
#define WEAK_REDEF1(type, fname, arg1) \
  type fname(arg1) __THROW WEAK(hoard_##fname)
#define WEAK_REDEF2(type, fname, arg1, arg2) \
  type fname(arg1, arg2) __THROW WEAK(hoard_##fname)
#define WEAK_REDEF3(type, fname, arg1, arg2, arg3) \
  type fname(arg1, arg2, arg3) __THROW WEAK(hoard_##fname)
