...
NO_INLINE void xcontext::commit(void) { getContext(); }

NO_INLINE void xcontext::abort(void) { restoreStack(1); }
...
#else
  /* Adapted from
   * http://www.awprofessional.com/articles/article.asp?p=606582&seqNum=4&rl=1
   */
